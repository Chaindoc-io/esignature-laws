...
**BGH on perpetual withdrawal in defective-Belehrung cases.** The line of BGH decisions including [II ZR 358/12 (2014)](https://juris.bundesgerichtshof.de/cgi-bin/rechtsprechung/) and follow-on decisions in consumer-credit and distance-selling contexts confirms that where the Belehrung is missing or substantively defective, the withdrawal period does not run and the contract remains revocable until the 12-month-plus-14-day deadline in § 356 Abs. 3 BGB expires. The decisions consistently reject trader arguments that consumer "real-world" understanding cures a formally-defective Belehrung.
